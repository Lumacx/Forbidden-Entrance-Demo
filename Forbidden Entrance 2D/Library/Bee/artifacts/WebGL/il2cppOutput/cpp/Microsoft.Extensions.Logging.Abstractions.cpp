...
IL_0009:
	...
	try
	{
		...
		String_t* L_4;
		L_4 = VirtualFuncInvoker1< String_t*, String_t* >::Invoke(9, L_2, L_3);
		V_0 = L_4;
		goto IL_001c;
	}
...
IL_002d:
	{
		...
		ValueStringBuilder_GrowAndAppend_m8A089D302254F4EB596A51D590AECB1454CE5124(__this, L_9, NULL);
		return;
	}
}
...
IL_0035:
	{
		int32_t L_10 = V_2;
		Il2CppChar* L_11;
		L_11 = il2cpp_span_get_item((Il2CppChar*)((Il2CppByReference*)&(((&V_1))->____pointer))->value, (L_10), ((&V_1))->____length);
		Il2CppChar* L_12 = ___0_value;
		Il2CppChar* L_13 = L_12;
		___0_value = ((Il2CppChar*)il2cpp_codegen_add((intptr_t)L_13, 2));
...
IL_0049:
	...
	}
	{
		...
		__this->____pos = ((int32_t)il2cpp_codegen_add(L_18, L_19));
		return;
	}
}
...
IL_0045:
	{
		...
		bool L_21;
		L_21 = VirtualFuncInvoker0< bool >::Invoke(38, L_20);
		if (!L_21)
		{
			goto IL_0063;
		}
...
IL_00b1:
	...
	}
	{
		...
		bool L_62;
		L_62 = VirtualFuncInvoker0< bool >::Invoke(38, L_61);
		if (L_62)
		{
			goto IL_00e9;
		}
...
IL_0022:
	{
		...
		RuntimeObject* L_8;
		L_8 = InterfaceFuncInvoker1< RuntimeObject*, String_t* >::Invoke(0, ILoggerFactory_t54A89DDF16F71A8E302F80F17BBDD1C8A148C526_il2cpp_TypeInfo_var, L_5, L_7);
		return L_8;
	}
}
#ifdef __clang__
...
IL_000f:
	{
		...
		(L_2)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_3), (KeyValuePair_2_tBEE55F2A4574C64393155C322376FD98C7BFC7B9)L_11);
		int32_t L_12 = V_1;
		V_1 = ((int32_t)il2cpp_codegen_add(L_12, 1));
	}
...
IL_002e:
	...
	}
	{
		...
		(L_16)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(((int32_t)il2cpp_codegen_subtract(((int32_t)(((RuntimeArray*)L_17)->max_length)), 1))), (KeyValuePair_2_tBEE55F2A4574C64393155C322376FD98C7BFC7B9)L_19);
